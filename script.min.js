...
let random_c_to_f = (c * 9) / 5 + 32;
console.log("\n\n**Random Celsius to Fahrenheit**:");
console.log(c + '\u00B0C is ' + random_c_to_f + '\u00B0F');

let randomF = Math.random();
let randomF_to_c = (f - 32) / 9 * 5;
console.log("\n\n**Random Fahrenheit to Celsius**:");
console.log(f + '\u00B0F is ' + randomF_to_c + '\u00B0C');
...
function halfNumber (wholeNumber) {
  let half = (wholeNumber/2);
  console.log("Half of " + wholeNumber + " is " + half);
  return half;
};
